return function(Window, Tabs)
    ...
    local InfoSection = Tabs.Info:AddSection("Kayzee Information", true)
...
If you have suggestions or found bugs, please report them to <font color="rgb(0,170,255)">Discord Kayzee</font>!<br/>
<b>Use at your own risk!</b>
    ...
    InfoSection:AddParagraph({
        Title = "Secret K Discord",
        Content = "Official link discord Secret K",
        Icon = "discord",
        ButtonText = "COPY LINK DISCORD",
        ButtonCallback = function()
            if setclipboard then
                setclipboard("https://discord.com/invite/BBtT8DE2A8")
    ...
    local currentJobId = "SK-" .. tostring(jobId)
