...
if not _G.httpRequest then
    ...
    local v3 = "Kayzee/FishIt" .. "/Position.json";
    local v4 = {
    ...
    local v139 = "https://raw.githubusercontent.com/Skyzee02/skntlxxnxxnxxnxxnxx04/refs/heads/main/2.lua";
    ...
    v228:AddToggle({
        ...
        Callback = function(v254) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v254 then
                ...
                v260.Text = "KAYZEE PANEL FISHING";
                v260.TextSize = 22;
    ...
    local function v430(v427) --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        if not v427 then
            ...
            if not l_status_8 then
                warn("[Kayzee] Totem spawn failed:", tostring(l_result_8));
            end;
            return;
        end;
    end;
    ...
    do
        ...
        local function v1005() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_hideident_0 or not l_hideident_0.overhead or not l_hideident_0.titleLabel then
                ...
                l_hideident_0.titleLabel.Text = "Kayzee";
    ...
    _G.WebhookFlags = {
        FishCaught = {
            Enabled = false, 
            URL = "https://canary.discord.com/api/webhooks/1439977170046025739/IT30Rhb_DemGnbi5vG7xjJoeQFQ9gQrF4dlPhkSSKyTbGnPProISNfrCa3H3JpDFZAsY"
        }, 
        Stats = {
            Enabled = false, 
            URL = "https://canary.discord.com/api/webhooks/1439977170046025739/IT30Rhb_DemGnbi5vG7xjJoeQFQ9gQrF4dlPhkSSKyTbGnPProISNfrCa3H3JpDFZAsY", 
                ...
                if not v1066 then
                    ...
                    elseif _G.WebhookNames and #_G.WebhookNames > 0 and not table.find(_G.WebhookNames, v1066.Name) then
                        ...
                        local v1071 = {
                            embeds = {
                                {
                                    title = "Kayzee Webhook | Fish Caught", 
                                    url = "https://discord.gg/BBtT8DE2A8", 
                    ...
                    local function v1179(v1144, v1145) --[[ Line: 0 ]] --[[ Name:  ]]
                        ...
                        if v1146 == "" then
                            ...
                            local v1178 = {
                                ...
                                embeds = {
                                    {
                                        title = "\227\128\162Kayzee Webhook | Player Info", 
                                        color = 52479, 
                                        fields = {
                                            {
                                    ...
                                    }, 
                                    {
                                        ...
                                        footer = {
                                            text = string.format("Kayzee Auto Sync | Every %dm", _G.WebhookFlags.Stats.Delay or 5), 
                                            icon_url = "https://i.imgur.com/WltO8IG.png"
                                        }, 
                                        timestamp = os.date("!%Y-%m-%dT%H:%M:%S.000Z")
                                    }
